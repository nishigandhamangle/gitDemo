...
a.	Create a class  Factorial using abstract class Processor  to calculate and 
...
print area of a circle by overriding the process method
 Ask user to enter choice (factorial or circle area).  Also ask data to work
  upon; Use Processor class reference to achieve this mechanism
*/
